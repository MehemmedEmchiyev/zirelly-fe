  ...
  return (
    <ModalShell isOpen={isOpen} onClose={onClose} titleId="reset-modal-title">
      <div className="pt-2 text-center">
        ...
        <p className="mt-2 text-sm text-zinc-500">{t("auth.resetSubtitle")}</p>
      ...
      <form onSubmit={handleSubmit} className="mt-6 flex flex-col gap-4">
        <div>
          ...
          <input
            ...
            placeholder="______"
            className={`${inputClasses} text-center tracking-[6px]`}
          />
        </div>
        ...
        >
          {loading ? t("common.loading") : t("auth.resetTitle")}
        </button>
